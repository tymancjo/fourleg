...
<42,76,83,92,91,83,68,109,122>
        ...
        lista_komend = """
            <42,89,64,106,99,74,81,91,116>;
            <42,74,81,91,116,89,64,106,99>
        """
        self.kom_btn.append(tk.Button(self,text="mallstp", command=lambda msg=lista_komend: serial_lista(msg, dt=300, n=10,s=1)))
        self.kom_btn[-1].grid(row=13,column=3)

# <42, 78,74, 102,106,78,74, 102,106>;
# <42, 97,69, 83,111,97,69,  83,111>;
# <42, 69,72, 111,108,69,72, 111,108>;
# <42, 74,78, 106,102,74,78, 106,102>;
